...
R_INITIAL = 12.0
ALARM_LEVEL = 1.0
DEFAULT_ACTIVITY = 26000  # uCi
DEFAULT_AIR_DENSITY = 0.0294  # g/cm^2
ACQUISITION_TIME = 1.0  # Fixed acquisition time
...
params = (Pdesired, DEFAULT_ACTIVITY, branching_ratio, DEFAULT_AIR_DENSITY, v, ACQUISITION_TIME, background_count_rate)
